...
void OwnerEditProduts::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OwnerEditProduts *_t = static_cast<OwnerEditProduts *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (OwnerEditProduts::*_t)();
...
const QMetaObject OwnerEditProduts::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_OwnerEditProduts.data,
      qt_meta_data_OwnerEditProduts,  qt_static_metacall, nullptr, nullptr}
};
